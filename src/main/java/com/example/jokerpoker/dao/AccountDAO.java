...
public class AccountDAO {
    public int checkUser(int id,String username,String password) {
        ...
        int n = -1;
        try {
            User p = queryRunner.query(cn,sql, h, id, username, password);
            if(p!=null) {
                n = 1;
            }
    ...
    public static void main(String[] args) {
        ...
        int n = accountDAO.checkUser(1000,"player1","123456");
